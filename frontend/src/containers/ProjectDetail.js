...
const ProjectDetail = (props) => {
  const { getProject, location } = props;
            ...
            <div className={style.controls}>
              <img
                src={
                  projectInfo.image
                    ? projectInfo.image
                    : 'http://localhost:8000/public/images/placeholder.png'
                }
                alt="cover"
            ...
            <div className="row">
              <div className="col-lg-4 col-md-4 col-xs-12">
                <div className="row">
                  ...
                  <div className="col-9">{projectInfo.name}</div>

                  <div className="col-3">Year:</div>
                  <div className="col-9">{projectInfo.year}</div>

                  <div className="col-3">Status:</div>
                  <div className="col-9">{projectInfo.status}</div>

                  <div className="col-3">Stack:</div>
                  <div className="col-9">
                    <ul>
